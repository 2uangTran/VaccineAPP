...
const ConfirmationScreen = ({ route }) => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <TouchableOpacity>
      <Text style={{ paddingTop: 10, textAlign: 'center', color: COLORS.blue, fontSize: 16, fontStyle: 'italic', textDecorationLine: 'underline' }}>
        Xem chi tiết đơn hàng
        </Text>
      </TouchableOpacity>   
     <View style={{ flexDirection: 'column', alignItems: 'center', paddingHorizontal: 20 , paddingTop:5}}>
    ...
    <Text style={{ textDecorationLine: 'underline', fontSize: 16 }}>Lưu ý:</Text>
        ...
        <Text style={{textAlign:'center',paddingTop:20,fontSize:16}}>Cảm ơn quý khách đã tin tưởng và sử dụng dịch vụ của chúng tôi</Text>
    </View>
