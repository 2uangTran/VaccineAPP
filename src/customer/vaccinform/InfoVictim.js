      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.headerContainer}>
          <TouchableOpacity onPress={toggleDetails} style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            <Feather name={detailsVisible ? "chevron-up" : "chevron-down"} size={20} color="black" />
          </TouchableOpacity>
        </View>
        {loading ? (
          <Text>Loading...</Text>
          ...
          <View style={styles.infoBox}>
            <View style={styles.infoRow}>
              ...
              <Text style={[styles.infoText, { textAlign: 'right' }]}>{userInfo.fullName}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>Số điện thoại</Text>
              <Text style={[styles.infoText, { textAlign: 'right' }]}>{userInfo.phone}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>Ngày sinh</Text>
              <Text style={[styles.infoText, { textAlign: 'right' }]}>{userInfo.birthDate}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>Mối quan hệ</Text>
              <Text style={[styles.infoText, { textAlign: 'right' }]}>Bản thân</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>Email</Text>
              <Text style={[styles.infoText, styles.fullWidth, { textAlign: 'right' }]}>{userInfo.email}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>Địa chỉ</Text>
              <Text style={[styles.infoText, styles.fullWidth, { textAlign: 'right' }]}>{`${userInfo.address}, ${userInfo.ward}\n${userInfo.district}, ${userInfo.province}`}</Text>
            </View>
          </View>
        ) : null}
          ...
          <TouchableOpacity onPress={() => setShowDatePicker(true)}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <TextInput
                ...
                editable={false}
              />
              <Feather name="calendar" size={24} color="#007bff" style={styles.iconbutton} />
            </View>
          </TouchableOpacity>
          <DateTimePickerModal
        ...
        <View style={styles.formGroup}>
          ...
          <View style={{ flexDirection: 'column', alignItems: 'center', padding:50}}>
            <FontAwesome6
              ...
              color={COLORS.gray}
            />
              <Text style={{ left:'14%',color:'#CCCCCC' ,width:'100%'}}>Danh sách vắc xin chọn mua trống</Text>
          </View>
        </View>
  ...
  >
    <View style={styles.modalOverlay}>
      <Animated.View style={[styles.modalContent, { transform: [{ translateY: slideAnim }] }]}>
        ...
        {showCheckBox && ( 
          <TouchableOpacity onPress={closeModal} style={styles.buttonConfirm}>
